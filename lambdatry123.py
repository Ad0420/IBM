...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        speak_output = "Welcome to the LED Controller. You can say, turn on the light or turn off the light."
        return (
...
class LedLightIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        if intent_name == "ledLight":
            if "turn on light" in slots:
                state = "ON"
            elif "turn off light" in slots:
                state = "OFF"
            else:
                return build_response("Sorry, I didn't understand that. You can say, turn on the light or turn off the light.")
        ...
        try:
            ...
            return build_response(f"Sorry, there was an error turning {state} the light. Error details: {e}")

        return build_response(f"Turning {state} the light.")
...
class HelpIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        speak_output = "You can say something like, turn on the light or turn off the light!"
        return (
            handler_input.response_builder
                .speak(speak_output)
                .ask(speak_output)
